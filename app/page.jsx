    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 animate__animated animate__fadeInDown">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
            Premium collection of tiles to transform your space into a
            masterpiece.
          </p>
          <Link
            href="/all-tiles"
            className="btn btn-primary btn-lg rounded-full px-10 text-white hover:scale-110 transition-all shadow-xl border-none animate__animated animate__zoomIn animate__delay-2s"
          >
            Browse Now
          </Link>
        </div>
      ...
      <div className="bg-primary py-4 shadow-inner">
        ...
        >
          ...
          <span className="mx-10">
            Premium Italian Finish Tiles Now In Stock |
          </span>
        </Marquee>
      </div>
      ...
      <section className="py-20 container mx-auto px-4">
        <div className="flex justify-between items-end mb-12 animate__animated animate__fadeInLeft">
          ...
          <Link
            href="/all-tiles"
            className="link link-primary font-bold hidden md:block"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {tiles.length > 0 ? (
            tiles.map((tile, index) => (
              ...
              >
                ...
                <div className="card-body">
                  <h2 className="card-title text-neutral font-black uppercase italic tracking-tighter">
                    {tile.title}
                  </h2>
                  ...
                  <div className="card-actions justify-end mt-4">
                    <Link
                      href={`/tile/${tile._id}`}
                      className="btn btn-outline btn-primary btn-sm rounded-xl font-bold uppercase"
                    >
                      View Details
                    </Link>
                  </div>
            ...
            <div key="abcd" className="col-span-full text-center py-20">
              <span className="loading loading-dots loading-lg text-primary"></span>
              <p className="mt-4 text-gray-500 font-bold italic animate__animated animate__pulse animate__infinite">
                Waking up the database... Please wait.
              </p>
            </div>
          )}
        </div>
